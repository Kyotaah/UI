...
if (getgenv and not getgenv().ConfirmHanto) or (not getgenv) then
	Hanto:Notification({ 
    	...
    	Icon = "warning",
    	ImageSource = "Material",
    	Content = "If you are not the script developer, ignore this message. \n\n The Hanto Interface Library Is Deprecated And Not Recommended to Use. A New Library Is Available at nebulasoftworks.xyz/starlight. If you insist on using Hanto, set the getgenv().ConfirmHanto variable to true. "
	})
end

if isStudio then
	local Window = Hanto:CreateWindow({
		Name = "Nebula Client - Hanto Hub | Blade Ball",
		Subtitle = "by Nebula Softworks",
		LogoID = "123795201100198",
		LoadingEnabled = true,
		LoadingTitle = "Nebula Client (Hanto Hub)",
...
return Hanto
on 3","Option 4","Option 5","Option 6"},
		CurrentOption = {"Option 1","Option 3","Option 6"},
		MultipleOptions = true
	})
	Tabs.Main2:CreateDropdown({
